            ...
            <div class="form-group col-md-5 mb-3">
              ...
              <div class="col-md-9">
                ...
                <option disabled selected>Select Category</option>
                      ...
                      $products_cat = mysqli_query($link, "SELECT CategoryName From Category ");  // Use select query here

                      while($product_categoty = mysqli_fetch_array($products_cat))
                      {
                          echo "<option value='". $product_categoty['CategoryName'] ."'>" .$product_categoty['CategoryName'] ."</option>";  // displaying data in option menu
                      }
                      ?>
                </select>
              </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form id="addUser" action="malki_add_menu.php" method="post" onsubmit="return validateForm()">


            <div class="form-group col-md-5 mb-3">

              <div class="col-md-9">
                  <label for="addMenu_nameField" class="col-md-3 form-label">Category</label>
