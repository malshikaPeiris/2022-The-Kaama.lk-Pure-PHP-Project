    ...
    <div class="container">
        ...
        if ($result) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <table>
                    <tr>
                        <td style="width:250px;">
                            <center><img class="img" width="80px" height="80px" src="/image/step-1.jpg" alt="">
                                <h6>choose your favorite food</h6>
                            </center>
                        </td>
                        <td style="width:250px;">
                            <center><img class="img" width="80px" height="80px" src="./image/step-2.jpg" alt="">
                                <h6>free and fast delivery</h6>
                            </center>
                        </td>
                        <td style="width:250px;">
                            <center><img class="img" width="80px" height="80px" src="./image/step-3.jpg" alt="">
                                <h6>easy payments methods</h6>
                            </center>
                        </td>
                        <td style="width:250px;">
                            <center><img class="img" width="80px" height="80px" src="./image/step-4.jpg" alt="">
                ...
                <div class="card" style="width: 30rem; margin-left:400px; margin-top:120px;">
                <center>
            <img class="image" style="width:400px;" src="' . $image . '" />  
                ...
                <div class="card-body">
                  ...
                  <center><a href="tcash.php" class="btn btn-danger">Add to Cart</a></center>
                </div>
              </div>
