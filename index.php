            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="malki_add_menu.php" class="dropdown-item">Add Products</a>
                            <a href="malki_index.php" class="dropdown-item">Our Prouducts</a>

                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="display.php" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Payment</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="display.php" class="dropdown-item">Payments</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="display.php" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Profile</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="gindex.php" class="dropdown-item">Profile</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="display.php" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Client View</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="Customer_view.php" class="dropdown-item">Client View</a>
                        </div>
                    </div>
                </div>
            </nav>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">Janindu Gunasinghe</a>, All Right Reserved.
                        </div>
